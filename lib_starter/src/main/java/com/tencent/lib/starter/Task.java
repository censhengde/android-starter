 ...
 * * on 2019/4/16.
 * * com.emwit
 * 将所有在Application onCreat()中执行的耗时任务
 * 封装成一个Task对象。
 **/
public abstract class Task implements ITask {
    ...
    protected Context mContext = AppStarter.getContext();
    protected boolean mIsMainProcess = AppStarter.isMainProcess();// 当前进程是否是主进程
    ...
    public ExecutorService runOn() {
        return StarterExecutor.getIOExecutor();
    }
    /**
